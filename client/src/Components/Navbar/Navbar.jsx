        ...
        {user && (
          <>
            ...
            <div  className="dropdown dropdown-end z-50">
              ...
              <ul className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-box w-52 transition-colors duration-300">
                <li>
                ...
                <li className="mt-2">
                  <button onClick={logOut} className="w-full bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-2 rounded hover:bg-red-500 dark:hover:bg-red-600 hover:text-white transition-colors duration-200">
                    Logout
                  </button>
                </li>
              </ul>
