                    ...
                    {showConfirm && (
                      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40">
                        <div className="bg-white p-6 rounded-xl shadow-lg text-center max-w-sm">
                          <div className="flex items-center justify-center  mb-3"><span className="text-red-500 text-9xl border-2 border-red-600 rounded-full w-20 h-20 pt-7 pl-6"><Trash /></span></div>
